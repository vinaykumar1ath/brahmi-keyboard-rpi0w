...
install() {
    ...
    sed -i '/^exit 0/i /home/pi/keyboardattachment/main/mainstarter' /etc/rc.local # placing script to automatically start main_py during startup
}
...
uninstall () {
    ...
    sed -i '/mainstarter/d' /etc/rc.local
    ask_reboot
}
